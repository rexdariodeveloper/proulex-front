...
import { HabilidadResponsabilidadDialogComponent } from './dialogs/habilidadResponsabilidad/habilidad-responsabilidad.dialog';
...
const routes = [
    ...
    {
        path: 'puestos/:handle', redirectTo: 'puestos/:handle/', pathMatch: 'full'
    },
    {
        path: 'puestos/:handle/:id',
        component: PuestoComponent,
        resolve: {
            data: PuestoService,
        },
        data: { url: '/api/v1/puestos/detalle/' },
