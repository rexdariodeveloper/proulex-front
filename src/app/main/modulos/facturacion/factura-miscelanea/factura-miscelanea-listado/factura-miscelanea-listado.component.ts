...
@Component({
    selector: 'factura-miscelanea-listado',
    templateUrl: './factura-miscelanea-listado.component.html',
    styleUrls: ['./factura-miscelanea-listado.component.scss']

})
export class FacturaMiscelaneaListadoComponent {
    ...
    config: FichaListadoConfig = {
        ...
        icono: "view_list",
        columnaId: "id",
        rutaDestino: "/app/facturacion/factura-miscelanea/",
        columns: [
        ...
        displayedColumns: ['fecha', 'folio', 'cliente', 'monto', 'estatus', 'xml', 'pdf'],
        columasFechas: ['fecha'],
        listadoMenuOpciones: []
    };
