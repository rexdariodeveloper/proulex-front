...
import { PagoClientesListadoModule } from './pago-clientes/pago-clientes.module';
import { CXCReportesModule } from './reportes/reportes.module';

@NgModule({
    declarations: [
    ],
    imports: [
        PagoClientesListadoModule,
        CXCReportesModule,
