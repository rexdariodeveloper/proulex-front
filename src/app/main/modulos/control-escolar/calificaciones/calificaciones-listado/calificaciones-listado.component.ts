...
@Component({
    selector: 'calificaciones-listado',
    templateUrl: './calificaciones-listado.component.html',
    styleUrls: ['./calificaciones-listado.component.scss'],
    animations: fuseAnimations,
	encapsulation: ViewEncapsulation.None
})
export class CalificacionesListadoComponent {
    ...
    constructor(
        ...
        public _calificacionesService: CalificacionesService, 
    ...
    ngOnInit(): void {
        this.textoBuscador = this._calificacionesService.getTextoBuscador(this.router.url);
        ...
        .subscribe((datos) => {
            ...
            //this.tienePermiso = permisos.hasOwnProperty('EXPORTAR_EXCEL_CALIFICACIONES');
            ...
            if (permisos.hasOwnProperty('MOSTRAR_FILTROS')) {
                ...
                regAnio.formControl.valueChanges.pipe(takeUntil(this._unsubscribeAll)).subscribe((data) => {
                    ...
                    if (anio && modalidad) {
                        ...
                        this._calificacionesService.getFechas(json);
                    }
                });
                ...
                this._calificacionesService.onFechaChange.pipe(takeUntil(this._unsubscribeAll)).subscribe((data) => {
                    if (!!data?.fechas) {
        ...
        if (!!this.filter) {
            fromEvent(this.filter.nativeElement, 'keyup')
                ...
                .subscribe(() => {
                    ...
                    this._calificacionesService.setTextoBuscador(this.router.url,this.filter.nativeElement.value || '');
                });
        }
    }
    ...
    rutaDestino(rutaId: number){
        ...
        this.router.navigate(['/app/control-escolar/calificaciones/ver/'+ this.hashid.encode(rutaId)]);
    }

    exportar(){
        this._fichasDataService.getArchivo('/api/v1/captura_calificaciones/excel_listado');
    }
