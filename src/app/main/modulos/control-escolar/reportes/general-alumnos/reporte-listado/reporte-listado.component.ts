...
export class ReporteListadoComponent {
    ...
    config: FichaListadoConfig = {
        ...
        columns: [
            ...
            { name: 'plantelAlumno', title: 'Plantel', class: "mat-column-flex", centrado: false, type: null, tooltip: true },
            { name: 'nivel', title: 'Nivel', class: "mat-column-100", centrado: false, type: null }
        ],
        displayedColumns: ['totalAlumnos', 'plantelAlumno', 'nivel'],
        columasFechas: [],
        listadoMenuOpciones: [],
        listadoAcciones: []
    };
    ...
    opciones: ListadoMenuOpciones[] = [
        { title: 'Descargar Reporte', icon: 'play_for_work', tipo: FichaListadoConfig.EXCEL, url: "/api/v1/reporte-general-alumnos/exportar/xlsx" },
    ];
