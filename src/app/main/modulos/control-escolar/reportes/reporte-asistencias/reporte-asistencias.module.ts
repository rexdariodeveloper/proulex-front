...
import { ReporteAsistenciasService } from './reporte-listado/reporte-listado.service';
...
const routes = [
    {
        ...
        data: { url: '/api/v1/captura_asistencia/reporte' }
    }
];
...
export class ReporteAsistenciasModule {
}