...
import { ReporteHistorialComprasComponent } from './reporte/reporte.component';
import { ReporteHistorialComprasService } from './reporte/reporte.service';
...
const routes = [
	{
		path: 'reportes/historial-compras',
		component: ReporteHistorialComprasComponent,
		resolve: {
			data: ReporteHistorialComprasService,
		},
		data: {
			url: '/api/v1/ordenes-compra/historial'
		}
	}
];
...
@NgModule({
	declarations: [
		// Components
		ReporteHistorialComprasComponent,
	...
	providers: [
		ReporteHistorialComprasService
	],
	entryComponents: [
	]
})

export class ReporteHistorialComprasModule {}