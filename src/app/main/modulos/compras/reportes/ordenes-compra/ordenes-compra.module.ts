...
import { ReporteOrdenesCompraComponent } from './reporte/reporte.component';
import { ReporteOrdenesCompraService } from './reporte/reporte.service';
...
const routes = [
	{
		path: 'reportes/ordenes-compra',
		component: ReporteOrdenesCompraComponent,
		resolve: {
			data: FichasDataService,
		},
		data: {
			url: '/api/v1/ordenes-compra/reporte'
		}
	}
];
...
@NgModule({
	...
	providers: [
        FichasDataService,
		ReporteOrdenesCompraService
	],
	entryComponents: [
	]
})

export class ReporteOrdenesCompraModule {}