...
import { EstadoCuentaService } from './reporte/reporte.service';
import { EstadoCuentaComponent } from './reporte/reporte.component';
...
const routes = [
	{
		...
		resolve: {
			data: EstadoCuentaService,
		},
		data: {
			url: '/api/v1/ordenes-compra/estado-cuenta'
		}
	}
];
