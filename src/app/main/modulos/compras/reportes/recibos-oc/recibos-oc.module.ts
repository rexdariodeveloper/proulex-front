...
import { RecibosOCComponent } from './recibos-oc/recibos-oc.component';
import { FiltrosReporteSidebarComponent } from './recibos-oc/sidebars/main/filtros-reporte-sidebar.component';

const routes = [
    {
        path: 'reportes/recibos-ocs',
        component: RecibosOCComponent,
        resolve: {
            data: FichasDataService,
        },
        data: { url: '/api/v1/reporte_oc/all' }
    }
];
