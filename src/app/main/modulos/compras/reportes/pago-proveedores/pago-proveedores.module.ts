...
import { ReportePagoProveedoresService } from './reporte/reporte.service';
...
const routes = [
	{
		...
		resolve: {
			data: ReportePagoProveedoresService,
		},
		data: {
			url: '/api/v1/pago-proveedores/report/all'
		}
	}
];
...
@NgModule({
	...
	providers: [
		ReportePagoProveedoresService
	],
	entryComponents: [
	]
})

export class ReportePagoProveedoresModule {}