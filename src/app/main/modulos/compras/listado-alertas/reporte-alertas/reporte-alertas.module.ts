...
import { ReporteAlertasComponent } from './reporte/reporte.component';
import { ReporteAlertasService } from './reporte/reporte.service';
...
const routes = [
	{
		...
		component: ReporteAlertasComponent,
		resolve: {
			data: ReporteAlertasService,
		},
		data: {
			url: '/v1/alerta/all'
		}
...
@NgModule({
	...
	providers: [
		ReporteAlertasService
	],
	entryComponents: [
	]
})

export class ReporteAlertasModule {}