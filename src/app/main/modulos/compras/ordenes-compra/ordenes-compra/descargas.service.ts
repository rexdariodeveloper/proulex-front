...
@Injectable()
export class OCDescargasService implements Resolve < any > {
	...
	getFactura(facturasIds: number[], oc: OrdenCompraListadoProjection): Promise<any> {
		let body = {
	...
	getArchivos(evidenciaIds: number[], nombreArchivo: string): Promise<any> {
		let body = {
