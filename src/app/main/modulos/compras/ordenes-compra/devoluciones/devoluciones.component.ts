...
@Component({
    selector: 'devolucion-ordenes-compra-listado',
    templateUrl: './devoluciones.component.html',
    styleUrls: ['./devoluciones.component.scss']

})
export class DevolucionOrdenesCompraListadoComponent {
	// @ViewChild('menuEvidencias') menuEvidencias;

    config: FichaListadoConfig = {
        localeEN: english, localeES: spanish,
        icono: "assignment_return",
        columnaId: "id",
        rutaDestino: "/app/compras/devolucion-oc/",
        columns: [
