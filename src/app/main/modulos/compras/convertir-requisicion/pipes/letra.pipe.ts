...
export class LetraPipe implements PipeTransform {
    ...
    lang: string = 'es';
    currencyDetails: any[] = [
        {sat: 'MXN', clave:'MXN', plural:'PESOS', singular:'PESO'},
        {sat: 'USD', clave:'USD', plural:'CURRENCY.DOLARES' , singular:'CURRENCY.DOLAR'},
        {sat: 'EUR', clave:'EUR', plural:'EUROS' , singular:'EURO'}
    ];
    ...
    transform(numero: string | number, currency?: string): string {
        ...
        let cur = this.currencyDetails.find( detail => detail.sat == (currency? currency : 'MXN'));
