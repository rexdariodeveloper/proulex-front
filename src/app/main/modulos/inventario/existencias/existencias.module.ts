...
import { FiltrosReporteSidebarComponent } from './existencias/sidebars/main/filtros-reporte-sidebar.component';
...
const routes = [
    {
        ...
        data: { url: '/api/v1/existencias/all' }
    },
    {
        path: 'existencias/:handle', redirectTo: 'existencias/:handle/', pathMatch: 'full'
    }
];
