...
@Component({
    selector: 'recibir-transferencias-listado',
    templateUrl: './recibir-transferencias.component.html',
    styleUrls: ['./recibir-transferencias.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class RecibirTransferenciasComponent {

    private URL: string = '/api/v1/transferencias/recibir';
    ...
    constructor(
		...
		this.config = {
			...
			columnaId: "id",
			rutaDestino: "/app/inventario/recibir-transferencias/",
			columns: [
				{
					name: 'codigo',
