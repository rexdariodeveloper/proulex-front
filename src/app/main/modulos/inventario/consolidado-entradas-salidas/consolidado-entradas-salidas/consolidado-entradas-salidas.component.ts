...
@Component({
    selector: 'consolidado-entradas-salidas',
    templateUrl: './consolidado-entradas-salidas.component.html',
    styleUrls: ['./consolidado-entradas-salidas.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class ConsolidadoEntradasSalidasComponent {
                ...
                datos => {
                    if (datos?.datos) {
                        ...
                        this.filtros = [
                            {
                                ...
                                multiple: false,
                                selectAll: false,
                                list: [{id: 1, name: 'Entradas'}, {id: 2, name: 'Salidas'}],
                                campoValor: 'name',
                                values: ['name']
                            },
                            {
                            ...
                            {
                                type: "pixvsMatSelect",
                                label: this.translate.instant('ALMACEN'),
                                name: "almacenes",
                                formControl: new FormControl(null,[Validators.required]),
                                validations: [],
                                multiple: true,
                        ...
                        this.filtrosOpciones = [{
                            ...
                            url: '/api/v1/consolidado-entradas-salidas/pdf'
                        },{
                            title: 'XLSX',
                            icon: 'arrow_downward',
                            tipo: FichaListadoConfig.PERSONALIZADO,
                            url: '/api/v1/consolidado-entradas-salidas/xls'
                        }];
                    }
