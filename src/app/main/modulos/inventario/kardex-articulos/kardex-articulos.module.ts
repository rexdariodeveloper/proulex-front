...
import { KardexArticulosComponent } from './kardex-articulos/kardex-articulos.component';
import { FiltrosReporteSidebarComponent } from './kardex-articulos/sidebars/main/filtros-reporte-sidebar.component';

const routes = [
    {
        path: 'kardex-articulos',
        component: KardexArticulosComponent,
        resolve: {
            data: FichasDataService,
        },
        data: { url: '/api/v1/kardex/all' }
    },
    {
        path: 'kardex-articulos/:handle', redirectTo: 'kardex-articulos/:handle/', pathMatch: 'full'
    }
];

@NgModule({
    declarations: [
        KardexArticulosComponent,
...
export class KardexArticulosModule {
}