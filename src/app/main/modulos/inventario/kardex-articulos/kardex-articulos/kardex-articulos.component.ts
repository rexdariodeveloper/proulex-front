...
@Component({
    selector: 'kardex-articulos-listado',
    templateUrl: './kardex-articulos.component.html',
    styleUrls: ['./kardex-articulos.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class KardexArticulosComponent {
                    ...
                    if (datos?.datos) {
                        ...
                        this.filtros = [
                            ...
                            },
                            {
                                ...
                                inputType: "text",
                                name: "referencia",
                                validations: [{"name": "maxlength","validator": Validators.maxLength(20),"message": "Máximo 20 caracteres"}]
                            },
                            {
                                type: "checkbox",
                                label: "Reporte lineal",
                                name: "tipo"
                            },
                            {
                                type: "button",
                        ...
                        this.filtrosOpciones = [{
                            ...
                            url: '/api/v1/kardex/pdf'
                        },{
                            title: 'XLSX',
                            icon: 'arrow_downward',
                            tipo: FichaListadoConfig.PERSONALIZADO,
                            url: '/api/v1/kardex/xls'
                        }];
                    }
