...
import { ContableInventariosComponent } from './contable-inventarios/contable-inventarios.component';
import { FiltrosReporteSidebarComponent } from './contable-inventarios/sidebars/main/filtros-reporte-sidebar.component';

const routes = [
    {
        path: 'contable-inventarios',
        component: ContableInventariosComponent,
        resolve: {
            data: FichasDataService,
        },
        data: { url: '/api/v1/contable_inventarios/all' }
    },
    {
        path: 'contable-inventarios/:handle', redirectTo: 'contable-inventarios/:handle/', pathMatch: 'full'
    }
];

@NgModule({
    declarations: [
        ContableInventariosComponent,
...
export class ContableInventariosModule {
}