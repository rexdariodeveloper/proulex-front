...
export interface PedidoInvoiceData {
	codigo: string,
	destinoSede: any,
	destinoAlmacen: any,
	cedisSede: any,
...
export class InvoicePrintComponent {
	...
	setData(data: PedidoInvoiceData){
		this.data = data;
        ...
        this.data.data.forEach(item => {
            this.totalCantidad +=  item.surtir;
            this.totalImporte += item.surtir * item.articulo.costoUltimo;
		});
	}
