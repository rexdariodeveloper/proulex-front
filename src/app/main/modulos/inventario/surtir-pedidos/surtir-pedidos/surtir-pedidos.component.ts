...
@Component({
    selector: 'surtir-pedidos-listado',
    templateUrl: './surtir-pedidos.component.html',
    styleUrls: ['./surtir-pedidos.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class SurtirPedidosComponent {
    ...
    constructor(
		...
		this.config = {
			...
			icono: "archive",
			columnaId: "id",
			rutaDestino: "/app/inventario/surtir/",
			columns: [
				{
					name: 'codigo',
