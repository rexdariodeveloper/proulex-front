...
export interface ComponentesDialogData {
	articuloId: number;
	existencias: any[];
...
export class ComponentesDialogComponent {
	...
	constructor(
		public dialogRef: MatDialogRef<ComponentesDialogComponent>,
		private _fuseTranslationLoaderService: FuseTranslationLoaderService,
		private _formBuilder: FormBuilder,
		private translate: TranslateService,
		@Inject(MAT_DIALOG_DATA) public data: ComponentesDialogData,
	...
	setData(data: ComponentesDialogData) {
