...
export class AddExamenComponent {
	...
	testFormatControl: FormControl = new FormControl(null,[Validators.required]);
	...
	aceptar(): void {
		if(this.vista == 'nuevo'){
	        ...
	        if(form.valid){
        		...
        		this.testControl.markAsTouched();
        		this.testFormatControl.markAsTouched();
        		this.modalidadControl.markAsTouched();
	        	this.examenModalidadForm.controls.forEach(modalidad =>{
	        		this.markFormGroupTouched((modalidad) as FormGroup);
	        	});
	        	this.examenUnidadForm.controls.forEach(unidad =>{
	        		this.markFormGroupTouched((unidad) as FormGroup);
	        	});
