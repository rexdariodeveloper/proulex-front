...
export interface CambioProfesorTitularData {
...
export class CambioProfesorTitularComponent {
	profesorTitular: EmpleadoComboProjection;
	categoriaTitular: string;
	sueldoTitular: number;
	profesores: EmpleadoComboProjection[];
	...
	constructor(
		public dialogRef: MatDialogRef < CambioProfesorTitularComponent > ,
		private _formBuilder: FormBuilder,
		@Inject(MAT_DIALOG_DATA) public data: CambioProfesorTitularData,
	...
	setData(data: CambioProfesorTitularData) {
	...
	aceptar(): void {
		...
		if(!this.sueldoNuevo || !this.categoriaNuevo){
