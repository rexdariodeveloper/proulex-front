...
export class FuseMaterialColorPickerComponent implements ControlValueAccessor
{
    ...
    @Input() configPaleta: any = {textopaleta: 'Select a Color', mostrarMatriz: false};;
    ...
    constructor()
    {
        ...
        this.selectedColor = {
            palette : 'fuse-black',
            hue     : '500',
            class   : 'fuse-black-500',
            bg      : 'black',
            fg  :    'white'
          }
        this.selectedPalette = 'fuse-black'
    }
    ...
    selectPalette(event, palette): void
    {
        ...
        // Go to 'hues' view
        if(!!this.configPaleta.mostrarMatriz)
            this.view = 'hues';
