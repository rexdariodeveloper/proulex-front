...
export class ExampleChartComponent implements OnInit, OnChanges {

    @Input() transitionTime:number = 1000;
    @Input() xmax:number = 45;
    @Input() ymax:number = 200;
    @Input() hticks: number = 60;
    @Input() data: number[];
